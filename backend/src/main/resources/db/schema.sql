...
CREATE TABLE public."statistics" ( id bigserial NOT NULL, user_id int8 NOT NULL, is_correct bool NOT NULL, problem_type varchar(32) NOT NULL, reference_id int8 NOT NULL, submitted_at timestamp(6) DEFAULT CURRENT_TIMESTAMP NULL, CONSTRAINT statistics_pkey PRIMARY KEY (id), CONSTRAINT fk_statistics_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE);
...
CREATE TABLE public.study_session ( id int8 GENERATED ALWAYS AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL, user_id int8 NOT NULL, subject_id int4 NOT NULL, session_type varchar(32) NOT NULL, status varchar(32) DEFAULT 'IN_PROGRESS'::character varying NULL, CONSTRAINT study_session_pkey PRIMARY KEY (id), CONSTRAINT fk_session_subject FOREIGN KEY (subject_id) REFERENCES public.subject(id) ON DELETE CASCADE, CONSTRAINT fk_session_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE);
...
CREATE TABLE public.wrong_answer_bookmark ( id int8 GENERATED ALWAYS AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL, user_id int8 NOT NULL, item_type varchar(32) NOT NULL, reference_id int8 NOT NULL, bookmarked_at timestamp DEFAULT CURRENT_TIMESTAMP NULL, review_count int4 DEFAULT 0 NULL, CONSTRAINT wrong_answer_bookmark_pkey PRIMARY KEY (id), CONSTRAINT fk_bookmark_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE);
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO service_role;
...
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT REFERENCES, TRUNCATE, TRIGGER, MAINTAIN, UPDATE, DELETE, SELECT, INSERT ON TABLES TO service_role;
