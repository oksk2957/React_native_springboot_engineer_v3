# [Hibernate] Users 테이블 Username NOT NULL 오류 해결 계획
...
### 📊 오류 발생 상황
- **시간**: 2026-05-04T13:17:22.991+09:00 (PM 1:17:22)
- **애플리케이션**: InformationExamBackendApplication (Spring Boot 3.2.5)
- **Hibernate ORM**: 6.4.4.Final
- **데이터베이스**: PostgreSQL (HikariPool-1)
...
- **검증 내용**:
  ...
  3. `@ColumnDefault("'unknown'")` 사용으로 기본값 설정 가능
  4. `@DynamicInsert`와 함께 사용하여 INSERT 시 기본값 적용
...
- **검증 내용**:
  ...
  5. ddl-auto="update"는 개발환경에서만 사용 권장
...
1. **Hibernate ORM** (/hibernate/hibernate-orm)
   ...
   - DDL 자동 생성 정책
   - @DynamicInsert와 @ColumnDefault 조합
...
| 항목 | 내용 |
|------|------|
| 오류 발생 시각 | 2026-05-04T13:17:22.991+09:00 (PM 1:17:22) |
